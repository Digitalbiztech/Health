"""Mistral normalization provider using OpenAI compatibility mode."""
...
logger = logging.getLogger("normalization.mistral")

MAX_INPUT_CHARS = 18_000


class MistralNormalizer(TextNormalizer):
    name = "mistral"
    ...
    def normalize(self, raw_text: str, *, doc_id: str | None = None) -> str:
        ...
        try:
            ...
            if not content or not content.strip():
                raise NormalizationError("Mistral returned empty normalization output")
